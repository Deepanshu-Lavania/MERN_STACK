...
import image from "../../public/MyImage/Me_img-removebg-preview (1).png";
// import image from '../../public/MyImage/Me_img.jpg'
      ...
      <div className="container mx-auto px-4 md:px-6 pb-30 md:py-15">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="order-2 w-full md:w-1/2 space-y-5 sm:space-y-3 lg:space-y-2 lg:order-1">
            ...
            <h3 className="uppercase text-2xl md:text-3xl font-semibold text-indigo-600 "style={nameFont}>
              {jobTitle}
